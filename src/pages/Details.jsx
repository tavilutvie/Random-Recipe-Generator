                        ...
                        <div aria-hidden="true" className="hidden sm:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-screen">
                            ...
                            <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
                                <div className="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
                                    <img
                                        className="absolute inset-0 h-full w-full object-cover border-solid border-4 border-blue-600 rounded-3xl"
                                    ...
                                    <div className="relative px-8">
                                        <blockquote className="mt-8">
                                            <div className="relative text-lg font-medium text-white md:flex-grow">
                                                ...
                                                <p className="relative text-4xl bg-blue-700 text-center">
                                                    {data[0].strMeal}
                                                </p>
                                            </div>
                                            <footer className="mt-4">
                                                <p className="text-base font-semibold text-indigo-200 text-center bg-blue-600">{data[0].strDrinkAlternate}</p>
                                            </footer>
                                        </blockquote>
                                    </div>
                                </div>
                                <div className="mt-10">
                                    ...
                                    <div className="mt-10">
                                    <a href={data[0].strYoutube} target="_blank" rel="noreferrer" className="text-base font-medium text-indigo-600">
                                        {' '}
                                        Watch on youtube<span aria-hidden="true">&rarr;</span>{' '}
                                    </a>
                                    <br></br>
                                    <a href={data[0].strSource} target="_blank" rel="noreferrer" className="text-base font-medium text-indigo-600">
                                        {' '}
